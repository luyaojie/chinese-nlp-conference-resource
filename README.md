...
序号 | 报告题目 | 报告人 | 幻灯片
------------ | ------------- | ------------ | ------------
T1 | 面向自然语言处理的深度学习基础 | 邱锡鹏、颜航（复旦大学） | 
T2 | 开放域语义解析 | 韩先培、陈波（中国科学院软件研究所） | 
T3 | 图神经网络在自然语言处理中的应用 | 张岳（西湖大学） | 

### 问答与对话-技术与系统
序号 | 报告题目 | 报告人 | 幻灯片
------------ | ------------- | ------------ | ------------
T1 | 基于深度学习的机器阅读理解 | 崔一鸣（科大讯飞） | 
T2 | 问答系统 | 唐都钰、段楠（微软亚洲研究院） | 
T3 | 任务型对话系统 | 车万翔、张伟男（哈尔滨工业大学） | 
T4 | 人工智能在人机对话系统中的技术现状与挑战 | 严睿（北京大学） | 
